            ...
            <div class="carousel-courses">
                    ...
                    <div class="card rounded-custom shadow-effect me-2 mb-2"
                        ...
                        <div class="card-header blue-bg rounded-custom-top" style="height: 6rem">
                            <p class="height-text-card text-white font-size-custom text-center p-3 mulish-black">
                                <strong>KHÓA HỌC TOEIC 2 KỸ NĂNG
                                    (LISTENING & READING)</strong></p>
                        </div>
                        <div class="card-body">
                            <p class="card-text text-center mulish-black"><strong>Khóa học Pre TOEIC: </strong></p>
                            <p class="card-text text-center mulish-extrabold" style="height: 12rem">Dành cho các bạn học viên mất gốc
                                tiếng Anh</p>
                            <div class="d-flex align-content-center justify-content-center mitr-medium ">
                                <a href="" class="btn blue-bg text-white btn-sm mb-3  btn-long button-shake mulish-black">XEM
                                    CHI TIẾT</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-center">
                    <div class="card rounded-custom shadow-effect me-2 mb-2"
                        ...
                        <div class="card-body">
                            <p class="card-text text-center mulish-black"><strong>Khóa học Easy Flight:</strong></p>
                            <p class="card-text text-center mulish-extrabold" style="height: 12rem">Dành cho
                                các bạn học viên đã có kiến thức cơ bản nhưng chưa vững kiến thức.</p>
                            <div class="d-flex align-content-center justify-content-center mitr-medium ">
                                <a href="" class="btn blue-bg text-white btn-sm mb-3  btn-long button-shake mulish-black">XEM
                                    CHI TIẾT</a>
                            </div>
                ...
                <div class="d-flex justify-content-center">
                    <div class="card rounded-custom me-1 border-0"
                        ...
                        <img class="rounded-custom img-fluid shadow-effect"
                             ...
                             alt="" style="height: 70%; object-fit: cover">
                        <div class="pt-4">
                            <p class="card-text mulish-semibold" style="text-align:justify">Thầy Nino luôn tự hào khi chia sẻ những
                ...
                <div class="d-flex justify-content-center">
                    <div class="card rounded-custom me-1 border-0"
                        ...
                        <img class="rounded-custom img-fluid shadow-effect"
                             ...
                             alt="" style="height: 70%; object-fit: cover">
                        <div class="pt-4">
                            <p class="card-text mulish-semibold">Thầy Nino luôn tự hào khi chia sẻ những thành công trong việc nỗ lực
                                học TOEIC của học viên tại Nino’s Classes. Các bạn đã chứng minh rằng với sự cố gắng
                                bền bỉ cùng với đam mê học tập và sự hướng dẫn tận tâm của thầy Nino và đội ngũ
                                giáo viên, mọi mục tiêu đề ra đều có thể đạt được.</p>
                        </div>
            ...
            <div class="carousel-knowledge">
                <div class="d-flex justify-content-center">
                    <div class="card rounded-custom-23 shadow-effect me-1"
                         style="width:20rem; height: 70% ">
                        <img class="rounded-custom m-3" src="{{asset('images/homepage/section-1/banner.png')}}"
                             alt="Card image" style="height: 50%; object-fit: cover">
                        <div class="card-body">
                            <p class="height-text-card text-center mulish-black">BÀI VIẾT CHIA SẺ KIẾN THỨC SỐ 01</p>
                            <p class="card-text mulish-semibold ">Trung tâm Thầy Nino TOEIC Nhí Nhố hay còn được biết đến là Nino’s Classes ...</p>
                            <div class="d-flex align-content-center justify-content-center mitr-medium ">
                                <a href="" class="btn blue-bg text-white btn-sm mb-3  btn-long button-shake mulish-black">XEM
                                    CHI TIẾT</a>
                            </div>
